      ...
      <section className={`module-root ${isDarkTheme ? "dark" : "light"}`}>
        <div className="page">
          <header className="hero">
            ...
            <h1 className="page-title">Hjhg</h1>
            <p className="page-description">
              Starter module scaffolded for namespace <code>hjhg</code>.
          ...
          <div className="cards">
            <section className="card stack">
              ...
              <p className="card-copy">
                ...
                component is <code>hjhgModule/Widget</code>.
              </p>
            ...
            <section className="card stack">
              ...
              <Can I="view" a="hjhg">
                <span className="permission-pill">view:hjhg allowed</span>
              </Can>
