      ...
      <section className={`module-root ${isDarkTheme ? "dark" : "light"}`}>
        <div className="page">
          <header className="hero">
            ...
            <h1 className="page-title">Initial Test</h1>
            <p className="page-description">
              Starter module scaffolded for namespace <code>initial-test</code>.
          ...
          <div className="cards">
            <section className="card stack">
              ...
              <p className="card-copy">
                ...
                component is <code>initialTestModule/Widget</code>.
              </p>
            ...
            <section className="card stack">
              ...
              <Can I="view" a="initial-test">
                <span className="permission-pill">view:initial-test allowed</span>
              </Can>
