      ...
      <section className={`module-root ${isDarkTheme ? "dark" : "light"}`}>
        <div className="page">
          <header className="hero">
            ...
            <h1 className="page-title">Numele</h1>
            <p className="page-description">
              Starter module scaffolded for namespace <code>numele</code>.
          ...
          <div className="cards">
            <section className="card stack">
              ...
              <p className="card-copy">
                ...
                component is <code>numeleModule/Widget</code>.
              </p>
            ...
            <section className="card stack">
              ...
              <Can I="view" a="numele">
                <span className="permission-pill">view:numele allowed</span>
              </Can>
