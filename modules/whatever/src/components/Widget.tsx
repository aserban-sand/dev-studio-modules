      ...
      <section className={`module-root ${isDarkTheme ? "dark" : "light"}`}>
        <div className="page">
          <header className="hero">
            ...
            <h1 className="page-title">Whatever</h1>
            <p className="page-description">
              Starter module scaffolded for namespace <code>whatever</code>.
          ...
          <div className="cards">
            <section className="card stack">
              ...
              <p className="card-copy">
                ...
                component is <code>whateverModule/Widget</code>.
              </p>
            ...
            <section className="card stack">
              ...
              <Can I="view" a="whatever">
                <span className="permission-pill">view:whatever allowed</span>
              </Can>
